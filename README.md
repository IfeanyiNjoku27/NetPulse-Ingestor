...
> - **The Processor (Go - Your learning opportunity)**: A tiny Go service that consumes the data from the Kafka topic, logs it, and flags any "device" that has a latency higher than 200ms.
